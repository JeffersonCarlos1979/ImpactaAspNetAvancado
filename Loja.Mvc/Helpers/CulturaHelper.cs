...
namespace Loja.Mvc.Helpers
{
    public class CulturaHelper
    {
        ...
        private List<string> LinguagensSuportadas { get; } = new List<string>
        {
            "pt-BR",
            "en-US",
            "es"
        ...
        public static CultureInfo ObterCultureInfo()
        {
            ...
            var linguagem = linguagemSelecionada?.Value ?? LinguagemPadrao;//o ?? é um if dedicado a nulo. Se o primeiro termo for nulo, ele retorna o segundo termo.
